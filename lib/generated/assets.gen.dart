...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/animation_loading_chat.json
  LottieGenImage get animationLoadingChat =>
      const LottieGenImage('assets/animations/animation_loading_chat.json');

  /// List of all assets
  List<LottieGenImage> get values => [animationLoadingChat];
}
...
class $AssetsEnvGen {
  ...
  /// List of all assets
  List<String> get values => [aEnvDev, aEnvProd, aEnvStg];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/plugilo.svg
  SvgGenImage get plugilo => const SvgGenImage('assets/svg/plugilo.svg');

  /// File path: assets/svg/robot.svg
  SvgGenImage get robot => const SvgGenImage('assets/svg/robot.svg');

  /// List of all assets
  List<SvgGenImage> get values => [plugilo, robot];
}
